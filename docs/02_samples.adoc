...
Here I will present a JUnit5 test class link:https://github.com/kazurayam/ashotwrapper/blob/develop/src/test/java/com/kazurayam/ashotwrapper/samples/AShotWrapperDemo.java[`com.kazurayam.ashotwrapper.samples.AShotWrapperDemo`] to demonstrate how to use the `com.kazurayam.ashotwrapper.AShotWrapper` class.
...
[quote]
----
include::https://github.com/kazurayam/ashotwrapper/blob/develop/src/test/java/com/kazurayam/ashotwrapper/study/AShotWrapperDemo.java[lines=1..66]
----
...
image::https://kazurayam.github.com/ashotwrapper/samples/com.kazurayam.ashotwrapper.samples.AShotWrapperDemo/test_saveEntirePageImage.png[]
